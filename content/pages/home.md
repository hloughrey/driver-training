  ...
  items:
    - title: Very high first-Time Pass Rates
      subTitle: Our focused training program achieves a very high first-time pass
        rate, significantly higher than the national average of 56%.
    - title: Emergency Service ( Ambulance ) background
      subTitle: Train with former ambulance driving instructors and blue light
        specialists who understand the unique demands of your chosen career.
...
pricing:
  ...
  items:
    - title: Basic Packages
      subTitle: Our basic training packages range from £880 to £1,150, with your first
